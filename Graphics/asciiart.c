...
void Java_com_dozingcatsoftware_asciicam_AsciiConverter_getAsciiValuesBWNative(
...
void Java_com_dozingcatsoftware_asciicam_AsciiConverter_getAsciiValuesWithColorNative(
    JNIEnv* env, jobject thiz, 
    jbyteArray jdata, jint imageWidth, jint imageHeight, 
